  ...
  return (
    <div className="-mx-4 sm:mx-0 overflow-x-auto">
      <div className="min-w-[320px] px-4 sm:px-0">
        <div className="grid grid-cols-[1.5fr,70px,70px,40px] sm:grid-cols-[1fr,100px,100px,40px] gap-2 sm:gap-4 mb-3">
          <div className="text-xs sm:text-sm font-semibold text-purple-300">Module Name</div>
